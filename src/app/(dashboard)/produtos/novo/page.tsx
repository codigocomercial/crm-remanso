...
export default function NovoProdutoPage() {
    ...
    // Ao selecionar modelo, preenche automaticamente a categoria
    function handleModeloChange(code: string) {
        const modelo = modelos.find(m => m.code === code)
        setForm(prev => ({
            ...prev,
            modelo: code,
            category: modelo?.category ?? prev.category,
        }))
    }
    ...
    const selClass = "w-full px-3 py-2 text-[13px] rounded-lg border outline-none bg-white transition-all"
        ...
        <div className="animate-fade-in max-w-2xl">
            ...
            <div className="space-y-4">
                ...
                <div className="rm-card">
                    <p className="text-[11px] font-semibold uppercase tracking-wide mb-3" style={{ color: 'var(--neutral-500)' }}>
                        Foto do produto
                    </p>
                    <div className="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-[11px] mt-2" style={{ color: 'var(--neutral-500)' }}>JPG, PNG ou WebP. Máx. 5MB.</p>
                            {imageUrl && <p className="text-[11px] mt-1 font-semibold" style={{ color: 'var(--brand-teal)' }}>✓ Foto enviada</p>}
                        </div>
                    </div>
                </div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <select value={form.modelo} onChange={e => handleModeloChange(e.target.value)}
                                className={selClass} style={inputStyle} onFocus={onFocus} onBlur={onBlur}>
